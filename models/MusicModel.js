...
class MusicModel {
     ...
     validate() {
          ...
          if (!validator.isLength(this.title, { min: 1, max: 255 })) {
               errors.title = 'Title must be between 1 and 255 characters long';
          }

          if (!validator.isLength(this.description_fr, { min: 1, max: 2048 })) {
               errors.description_fr = 'Description must be between 1 and 2048 characters long';
          }

          if (!validator.isLength(this.description_en, { min: 1, max: 2048 })) {
